...
A curated, categorized index of every roadmap (as published on [roadmap.sh](https://roadmap.sh) ), community-driven, step-by-step guides for learning tools, technologies, and career paths. Included here as a reference collection inside this AI/ML resources repo.

> Source: [roadmap.sh](https://roadmap.sh) · [Full roadmap list](https://roadmap.sh/roadmaps)

---

## Role-Based Roadmaps
Step-by-step guides for specific job roles — what to learn and in what order.

| Roadmap | Description |
|---|---|
| [Frontend](https://roadmap.sh/frontend) | Path to becoming a modern frontend developer |
| [Backend](https://roadmap.sh/backend) | Path to becoming a backend developer |
| [Full Stack](https://roadmap.sh/full-stack) | Combined frontend + backend developer path |
| [Android](https://roadmap.sh/android) | Native Android app development path |
| [DevOps](https://roadmap.sh/devops) | Path to becoming a DevOps engineer |
| [DevSecOps](https://roadmap.sh/devsecops) | Integrating security into the DevOps lifecycle |
| [Data Analyst](https://roadmap.sh/data-analyst) | Path to becoming a data analyst |
| [AI Engineer](https://roadmap.sh/ai-engineer) | Building applications powered by LLMs and AI models |
| [AI and Data Scientist](https://roadmap.sh/ai-data-scientist) | Path to becoming an AI/data scientist |
| [Data Engineer](https://roadmap.sh/data-engineer) | Path to becoming a data engineer |
| [Machine Learning](https://roadmap.sh/machine-learning) | Path to becoming a machine learning engineer |
| [PostgreSQL DBA](https://roadmap.sh/postgresql-dba) | Path to becoming a PostgreSQL database administrator |
| [iOS](https://roadmap.sh/ios) | Native iOS app development path |
| [Blockchain](https://roadmap.sh/blockchain) | Path to becoming a blockchain developer |
| [QA](https://roadmap.sh/qa) | Path to becoming a QA / test engineer |
| [Software Architect](https://roadmap.sh/software-architect) | Path to becoming a software architect |
| [API Design](https://roadmap.sh/api-design) | Principles and practices of designing good APIs |
| [Cyber Security](https://roadmap.sh/cyber-security) | Path to becoming a cybersecurity specialist |
| [UX Design](https://roadmap.sh/ux-design) | Path to becoming a UX designer |
| [Technical Writer](https://roadmap.sh/technical-writer) | Path to becoming a technical writer |
| [Game Developer](https://roadmap.sh/game-developer) | Path to becoming a game developer |
| [Server Side Game Developer](https://roadmap.sh/server-side-game-developer) | Backend/server-side path for game development |
| [MLOps](https://roadmap.sh/mlops) | Operationalizing and deploying ML systems |
| [Product Manager](https://roadmap.sh/product-manager) | Path to becoming a product manager |
| [Engineering Manager](https://roadmap.sh/engineering-manager) | Path to becoming an engineering manager |
| [Developer Relations](https://roadmap.sh/devrel) | Path to becoming a DevRel professional |
| [BI Analyst](https://roadmap.sh/bi-analyst) | Path to becoming a business intelligence analyst |
| [AI Red Teaming](https://roadmap.sh/ai-red-teaming) | Testing and probing AI systems for safety/security issues |
| [Network Engineer](https://roadmap.sh/network-engineer) | Path to becoming a network engineer |
